...
fn get_cache_dir() -> Option<PathBuf> {
    dirs::cache_dir().map(|p| p.join("fastapi-swagger-ui"))
}
...
fn get_zip_archive(url: &str, target_dir: &str) -> SwaggerZip {
    ...
    if env::var("CARGO_FEATURE_VENDORED").is_ok() {
        ...
        #[cfg(feature = "vendored")]
        {
            ...
            let vendred_bytes = fastapi_swagger_ui_vendored::SWAGGER_UI_VENDORED;
        ...
        // with file protocol fastapi swagger ui should compile when file changes
