...
//! works as a bridge for serving the OpenAPI documentation created with [`fastapi`][fastapi] library in the
//! Swagger UI.
//!
//! [fastapi]: <https://docs.rs/fastapi/>
//!
...
//! <div class="warning">
//!
//! **Note!** _`fastapi-swagger-ui` crate will by default try to use system `curl` package for downloading the Swagger UI. It
...
//! [examples](https://github.com/nxpkg/fastapi/tree/master/examples/todo-actix).
//! ```no_run
...
//! [examples](https://github.com/nxpkg/fastapi/tree/master/examples/rocket-todo).
//! ```no_run
...
/// ```rust
/// # use fastapi_swagger_ui::{SwaggerUi, Config, oauth};
/// # use fastapi::OpenApi;
/// # #[derive(OpenApi)]
/// # #[openapi()]
/// # struct ApiDoc;
...
impl SwaggerUi {
    ...
    /// # use fastapi_swagger_ui::SwaggerUi;
    /// let swagger = SwaggerUi::new("/swagger-ui/{_:.*}")
    ///     .url("/api-docs/openapi.json", fastapi::openapi::OpenApi::new(
    ///        fastapi::openapi::Info::new("my application", "0.1.0"),
    ///        fastapi::openapi::Paths::new(),
    /// ));
    /// ```
    ///
    ...
    /// ```rust
    /// # use fastapi_swagger_ui::{SwaggerUi, Url};
    /// # use fastapi::OpenApi;
    /// # #[derive(OpenApi)]
    /// # #[openapi()]
    /// # struct ApiDoc;
    ...
    /// ```rust
    /// # use fastapi_swagger_ui::{SwaggerUi, oauth};
    /// # use fastapi::OpenApi;
    /// # #[derive(OpenApi)]
    /// # #[openapi()]
    /// # struct ApiDoc;
    ...
    /// ```rust
    /// # use fastapi_swagger_ui::{SwaggerUi, Config};
    /// # use fastapi::OpenApi;
    /// # #[derive(OpenApi)]
    /// # #[openapi()]
    /// # struct ApiDoc;
...
/// ```rust
/// # use fastapi_swagger_ui::{Config, Url};
...
/// With oauth config.
/// ```rust
/// # use fastapi_swagger_ui::{Config, oauth};
...
///
/// _There are also implementations in [examples of fastapi repository][examples]._
///
/// [examples]: https://github.com/nxpkg/fastapi/tree/master/examples
///
/// # Examples
...
///   match fastapi_swagger_ui::serve(tail_path.as_ref(), config) {
...
/// Is used to provide general way to deliver multiple types of OpenAPI docs via `fastapi-swagger-ui`.
#[cfg(any(feature = "actix-web", feature = "rocket", feature = "axum"))]
#[derive(Clone)]
enum ApiDoc {
    Fastapi(fastapi::openapi::OpenApi),
...
impl Serialize for ApiDoc {
        ...
        S: serde::Serializer,
    {
        match self {
            ...
            Self::Fastapi(fastapi) => fastapi.serialize(serializer),
        }
    }
}
