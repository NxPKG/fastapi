        ...
        fn into_params(
            ...
            vec![
                ParameterBuilder::new()
                    .name("name")
                    .schema(Some(
                        ObjectBuilder::new().schema_type(fastapi::openapi::schema::Type::String),
                    ))
...
fn path_with_all_args() {
    #![allow(unused)]
    #[derive(fastapi::ToSchema, serde::Serialize, serde::Deserialize)]
    struct Item(String);
...
fn derive_path_with_multiple_methods_skip_connect() {
    ...
    assert_eq!(
        vec![
            ...
            fastapi::openapi::path::HttpMethod::Head
        ],
