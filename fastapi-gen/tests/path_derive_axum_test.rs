...
use fastapi::{IntoParams, OpenApi};
...
fn derive_path_query_params_with_named_struct_destructed() {
    ...
    #[fastapi::path(get, path = "/item", params(QueryParmas))]
    #[allow(unused)]
...
fn path_with_path_query_body_resolved() {
    ...
    #[fastapi::path(path = "/item/{id}/{name}", params(Filter), post)]
    #[allow(unused)]
    async fn post_item(
...
fn path_param_single_arg_non_primitive_type_into_params() {
    #[derive(fastapi::ToSchema, fastapi::IntoParams)]
