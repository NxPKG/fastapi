...
builder! {
    ...
    /// ```rust
    /// # use fastapi::openapi::{Info, Paths, Components, OpenApiBuilder};
...
impl OpenApi {
    ...
    ///
    /// ```rust
    /// # use fastapi::openapi::{Info, Paths, OpenApi};
    /// #
    ...
    /// ```rust
    ///  # use fastapi::openapi::{OpenApi, OpenApiBuilder};
    ///  # use fastapi::openapi::path::{PathsBuilder, PathItemBuilder, PathItem,
