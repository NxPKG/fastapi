...
impl Paths {
    ...
    /// ```rust
    /// # use fastapi::openapi::path::{Paths, HttpMethod};
    /// # let paths = Paths::new();
...
impl PathsBuilder {
    ...
    /// ```rust
    /// # struct MyPath;
    /// # impl fastapi::Path for MyPath {
    /// #   fn methods() -> Vec<fastapi::openapi::path::HttpMethod> { vec![] }
    /// #   fn path() -> String { String::new() }
    /// #   fn operation() -> fastapi::openapi::path::Operation {
    /// #        fastapi::openapi::path::Operation::new()
    /// #   }
    /// # }
    /// let paths = fastapi::openapi::path::PathsBuilder::new();
...
builder! {
    ...
    pub struct Operation {
        ...
        ///
        /// When used with derive [`#[fastapi::path(...)]`][derive_path] attribute macro the default
        ...
        ///
        /// When used with derive [`#[fastapi::path(...)]`][derive_path] attribute macro the value
        ...
        ///
        /// When used with derive [`#[fastapi::path(...)]`][derive_path] attribute macro the
        ...
        ///
        /// When used with derive [`#[fastapi::path(...)]`][derive_path] attribute macro the handler function
