...
impl ComponentsBuilder {
    ...
    ///
    /// ```rust
    /// # use fastapi::{ToSchema, openapi::schema::ComponentsBuilder};
    ///  #[derive(ToSchema)]
    ///  struct Value(String);
    ///
    ...
    /// # Examples
    /// ```rust
    /// # use fastapi::openapi::schema::{ComponentsBuilder, ObjectBuilder,
    /// #    Type, Schema};
...
impl Discriminator {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::Discriminator;
...
impl OneOf {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::OneOf;
...
impl AllOf {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::AllOf;
...
impl AnyOf {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::AnyOf;
...
builder! {
    ...
    pub struct Object {
        ...
        pub multiple_of: Option<crate::fastapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub maximum: Option<crate::fastapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub minimum: Option<crate::fastapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub exclusive_maximum: Option<crate::fastapi::Number>,
        ...
        #[serde(skip_serializing_if = "Option::is_none", serialize_with = "omit_decimal_zero")]
        pub exclusive_minimum: Option<crate::fastapi::Number>,
...
impl Object {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::{Object, Type};
...
impl ObjectBuilder {
    ...
    pub fn multiple_of<N: Into<crate::fastapi::Number>>(mut self, multiple_of: Option<N>) -> Self {
    ...
    pub fn exclusive_minimum<N: Into<crate::fastapi::Number>>(
        mut self,
...
fn omit_decimal_zero<S>(
    maybe_value: &Option<crate::fastapi::Number>,
    serializer: S,
) -> Result<S::Ok, S::Error>
where
    S: serde::Serializer,
{
    match maybe_value {
        ...
        Some(crate::fastapi::Number::Int(int)) => serializer.serialize_i64(*int as i64),
        Some(crate::fastapi::Number::UInt(uint)) => serializer.serialize_u64(*uint as u64),
...
impl Array {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::{Schema, Array, Type, Object};
...
impl ArrayBuilder {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::{ArrayBuilder, SchemaType, Type, Object};
...
impl SchemaType {
    ...
    /// ```rust
    /// # use fastapi::openapi::schema::{SchemaType, Type};
...
/// # use fastapi::openapi::schema::{Type, SchemaType};
