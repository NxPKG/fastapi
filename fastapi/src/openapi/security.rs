...
/// to execute the operation. They can be defined in [`#[fastapi::path(...)]`][path] or in `#[openapi(...)]`
/// of [`OpenApi`][openapi].
///
/// Applying the security requirement to [`OpenApi`][openapi] will make it globally
/// available to all operations. When applied to specific [`#[fastapi::path(...)]`][path] will only
...
impl SecurityRequirement {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::SecurityRequirement;
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{SecurityRequirement, HttpAuthScheme, HttpBuilder, SecurityScheme};
    /// # use fastapi::{openapi, Modify, OpenApi};
    /// # use serde::Serialize;
...
/// ```rust
/// # use fastapi::openapi::security::{SecurityScheme, OAuth2, Implicit, Flow, Scopes};
...
/// ```rust
/// # use fastapi::openapi::security::{SecurityScheme, HttpAuthScheme, HttpBuilder};
/// SecurityScheme::Http(
...
impl ApiKeyValue {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::ApiKeyValue;
...
impl Http {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{SecurityScheme, Http, HttpAuthScheme};
...
impl HttpBuilder {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{HttpBuilder, HttpAuthScheme};
...
impl OpenIdConnect {
    ...
    ///
    /// ```rust
    /// # use fastapi::openapi::security::OpenIdConnect;
...
impl OAuth2 {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{OAuth2, Flow, Password, AuthorizationCode, Scopes};
...
impl Implicit {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{Implicit, Scopes};
    /// Implicit::new(
    ///     "https://localhost/auth/dialog",
    ///     Scopes::from_iter([
    ///         ("edit:items", "edit my items"),
...
impl AuthorizationCode {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{AuthorizationCode, Scopes};
    /// AuthorizationCode::new(
    ///     "https://localhost/auth/dialog",
...
impl Password {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{Password, Scopes};
    /// Password::new(
    ///     "https://localhost/token",
    ///     Scopes::from_iter([
    ///         ("edit:items", "edit my items"),
...
impl ClientCredentials {
    ...
    /// ```rust
    /// # use fastapi::openapi::security::{ClientCredentials, Scopes};
...
/// ```rust
/// # use fastapi::openapi::security::Scopes;
