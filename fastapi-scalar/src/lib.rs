...
///
/// By default this trait is implemented for [`fastapi::openapi::OpenApi`] and [`serde_json::Value`].
///
...
/// # Examples
///
/// _**Use [`Scalar`] to serve fastapi's OpenApi.**_
/// ```no_run
/// # use fastapi_scalar::Scalar;
